...
ISR( INT6_vect ) {
  ...
  // Convert the old and new states into a rotation step
  // Defining forwards as positive
  if (state_e0 == 1 || state_e0 == 7 || state_e0 == 8 || state_e0 == 14) {
    count_e0 -= 1; // Motor has moved backwards
  } else if (state_e0 == 2 || state_e0 == 4 || state_e0 == 11 || state_e0 == 13) {
    count_e0 += 1; // Motor has moved forwards
  }

  // if(state_e0 == 0) {
  //     // (no change, invalid)
  // } else if(state_e0 == 1) {
  //     count_e0 = count_e0 - 1; // Motor has moved backwards
  // } else if(state_e0 == 2) {
  //     count_e0 = count_e0 + 1; // Motor has moved forwards
  // } else if(state_e0 == 3) {
  //     // (change x2, invalid)
  // } else if(state_e0 == 4) {
  //     count_e0 = count_e0 + 1; // Motor has moved forwards
...
ISR(PCINT0_vect) {
  ...
  if ( state_e1 == 1 || state_e1 == 7 || state_e1 == 8 || state_e1 == 14 ) {
    count_e1 = count_e1 - 1; // Motor has moved backwards
  } else if ( state_e1 == 2 || state_e1 == 4 || state_e1 == 11 || state_e1 == 13 ) {
    count_e1 = count_e1 + 1; // Motor has moved forwards
  }
