...
float const WHEEL_RADIUS_R = 16.29; //16.24; // Wheel radius in mm right
float const WHEEL_RADIUS_L = 16.26; //16.22; // Wheel radius in mm left
...
class Kinematics_c {
  ...
  private:
    float const L = 42.51;//86.2 / 2; // Distance from wheel to center of robot in mm
